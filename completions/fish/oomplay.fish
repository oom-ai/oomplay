...
complete -c oomplay -n "__fish_use_subcommand" -f -a "update" -d 'Check for updates'
...
complete -c oomplay -n "__fish_seen_subcommand_from update" -s h -l help -d 'Print help information'
