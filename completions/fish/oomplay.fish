...
complete -c oomplay -n "__fish_use_subcommand" -f -a "start" -d 'Start playground'
complete -c oomplay -n "__fish_use_subcommand" -f -a "stop" -d 'Stop playground'
complete -c oomplay -n "__fish_use_subcommand" -f -a "reset" -d 'Reset playground'
complete -c oomplay -n "__fish_use_subcommand" -f -a "init" -d 'Start or reset playground'
